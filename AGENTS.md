...
- Builder `.setModifiers()` / `defineModel` `modifiers` receive executable model-owned declarations. The global catalogue contains stable UI/share IDs, `modifierInputs`, and `modifierInputRangeSi`.
